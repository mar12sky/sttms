                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="width: 50%;">
                                                    ...
                                                    <p class="font-weight-bold">MODE:
                                                        <?= strtoupper($contact['agenda_type']); ?></p>
                                                </td>
                                                <td>
                                                    <p class="font-weight-bold">DATE: <?= $contact['agenda_date'] ?></p>
                                                    <p class="font-weight-bold <?php if ($contact['agenda_type'] == 'zero-hours') {
                                                                                    echo 'd-none';
                                                                                }
                                                                                if ($contact['agenda_type'] == 'speaking') {
                                                                                    echo 'd-none';
                                                                                } else {
                                                                                } ?>">
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header bg-info">
                                                    ...
                                                    ?>
                                                    <h3 class="card-title font-weight-bold">PART WISE TIME DISTRIBUTION
                                                    </h3>
