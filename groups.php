...
<head>
    ...
    <title>STTMS | Parties Group</title>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        $stmt = $pdo->prepare('SELECT * FROM party_groups ORDER BY party_name');
                        ...
                        $num_contacts = $pdo->query('SELECT COUNT(*) FROM party_groups')->fetchColumn();
                        ?>
                        <!-- Default box -->
                        <div class="card col-12 p-1">
                            <div class="card-header bg-success">
                                <h3 class="card-title text-bold">LIST OF PARTIES GROUPS</h3>
                                            ...
                                            <div class="info-box" style="background: #e0ffff;">
                                                ...
                                                <div class="info-box-content">
                                                    <span class="info-box-number">
                                                        <?= $contact['group_name'] ?>
                                                        <small><a href="edit-group.php?id=<?= $contact['group_id'] ?>"
                                                                class="btn float-right"><i
                                                                    class="fas fa-edit"></i></a></small>
                                                    </span>
                                                    <span class="info-box-text">Strength:<small
                                                            class="float-right"><?= $contact['strength']; ?></small></span>
                                                    <!-- <div class="progress">
                        <div class="progress-bar bg-info" style="width: 70%"></div>
                      </div> -->
                                                    <!-- <span class="progress-description text-bold"></span> -->
