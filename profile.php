                  ...
                  <form id="edit-delegate-form" method="post" action="update-profile.php"
                    ...
                    <div class="card-body">
                      <div class="form-group" style="overflow: hidden;">
                        <img width="230" height="258" src="./pics/<?= $contact['pics'] ?>"
                          class="float-right">
                      </div>

                      <div class="form-group">
                        <label>Name in English:</label>
                        <input type="text" id="del_name_en" name="del_name_en"
                          class="form-control" value="<?= $contact['name_en'] ?>" required>
                      </div>
                      <div class="form-group">
                        <label>Name in Hindi:</label>
                        <input type="text" id="del_name_hi" name="del_name_hi"
                          class="form-control" value="<?= $contact['name_hi'] ?>" required>
                      </div>
                      <div class="form-group row">
                        <div class="form-group col-4">
                          <label>Division No.</label>
                          <input type="text" id="div_no" name="div_no" class="form-control"
                            value="<?= $contact['div_no'] ?>" required>
                        </div>
                        <div class="form-group col-4 d-none">
                          <label>IP Address:</label>
                          <input type="text" id="ip" name="ip" class="form-control"
                            value="<?= $contact['ip'] ?>" required>

                        </div>
                        <div class="form-group col-4">
                          <label>Designation?:</label>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="minister"
                              id="designation" name="designation"
                              <?= $contact['designation'] == 'minister' ? 'checked' : '' ?>>
                        ...
                        <div class="form-group col-4">
                          ...
                          <input type="text" id="state_name" name="state_name"
                            class="form-control" value="<?= $contact['state_name'] ?>"
                            required>
                        </div>
                        <div class="form-group col-4">
                          <label>Party Short Name:</label>
                          <input type="text" id="party" name="party" class="form-control"
                            value="<?= $contact['party'] ?>" required>
                        </div>
                        <div class="form-group col-4">
                          <label>Party Full Name:</label>
                          <input type="text" id="full_party_name" name="full_party_name"
                            class="form-control" value="<?= $contact['full_party_name'] ?>"
                            required>
                        </div>
                        <div class="form-group col-4">
                          <label>IP Address:</label>
                        ...
                        <div class="form-group col-4">
                          <label>Picture: <small>(.png files only) </small>
                          </label>
                    ...
                    <div class="card-footer">
                      <button id="add_session.php" type="sumit"
                        class="btn btn-primary float-left"><i class="fas fa-plus"></i>
                        Submit</button>
