                                                    ...
                                                    <li class="border mb-3">
                                                        ...
                                                        <span class="text">
                                                            <div class="icheck-primary d-inline ml-2">
                                                                <input type="checkbox" value="" name="todo<?= $speaker['div_no'] ?>"
                                                                    id="todoCheck<?= $speaker['div_no'] ?>">
                                                                <label for="todoCheck<?= $speaker['div_no'] ?>"></label>
                                                            </div>
                                                        </span>
                                                        <!-- todo text -->
                                                        <span class="text"><?= sprintf("%03d", $speaker['div_no']) ?></span>
                                                        <span class="text">
                                                            <input type="text" name="nt_<?= $speaker['div_no'] ?>"
                                                                id="nt_<?= $speaker['div_no'] ?>" class="" style="width: 50%;"
                                                                placeholder="--:--">
                                                        </span>
                                                        ...
                                                        <small class="badge">
                                                            ...
                                                            <script>
                                                                function startSpeaking_<?= $speaker['div_no'] ?>() {
                                                                    const atime_<?= $speaker['div_no'] ?> = document.getElementById(
                                                        ...
                                                        <small class="badge">
                                                            <button class="border-light h3" onclick="pauseSpeaking();">
                                                                <i class="fas fa-pause"></i>
                                                            </button>
                                                        </small>
                                                        <small class="badge">
                                                            <button class="border-light h3" onclick="extraTime();">
